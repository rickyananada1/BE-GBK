...
public class IncomeDTO {
    ...
    @JsonProperty("totalpendapatanevents")
    private BigDecimal totalPendapatanEvents;

    @JsonProperty("totalpendapataneventsproyeksi")
    private BigDecimal totalPendapatanEventsProyeksi;
