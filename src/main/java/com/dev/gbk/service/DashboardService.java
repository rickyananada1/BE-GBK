...
public class DashboardService {
    ...
    public CardGamesDTO getGamesCardData(String startDate, String endDate, String unit) {
        ...
        List<ScheduleDTO> paidSchedules = schedules.stream()
                ...
                .map(s -> new ScheduleDTO(s.getVenue().getVenue(), s.getScheduleStartDate(), s.getScheduleEndDate(),
                        s.getStatus()))
    ...
    public List<CardEventDTO> getEventCardData(String startDate, String endDate, String unit) {
        ...
        for (Schedule schedule : schedules) {
            ...
            ScheduleDTO scheduleDTO = new ScheduleDTO(schedule.getVenue().getVenue(),
                    schedule.getScheduleStartDate(), schedule.getScheduleEndDate(), schedule.getStatus());
