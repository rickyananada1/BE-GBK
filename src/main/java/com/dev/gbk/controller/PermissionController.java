...
public class PermissionController {
    ...
    public ResponseEntity<?> createPermissions(@Valid @RequestBody PermissionRequest permissionRequest) {
        Permission permission = new Permission(permissionRequest.getRole_id(), permissionRequest.getPermission_id(), permissionRequest.getCreate(), permissionRequest.getRead(), permissionRequest.getUpdate(), permissionRequest.getDelete());
