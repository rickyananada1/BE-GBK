package com.dev.gbk.spesification.entity;

import java.util.Map;
import static com.dev.gbk.utils.AppConstants.*;

public enum SearchOperation {
    EQUALITY, NEGATION, GREATER_THAN_OR_EQUAL, LESS_THAN_OR_EQUAL, LIKE, COLLECTION_CONTAINS, STARTS_WITH, ENDS_WITH,
    CONTAINS;

    private static final Map<String, SearchOperation> SEARCH_KEY_OPERATION_MAP;
    private static final String[] SIMPLE_OPERATION_SET = { COLON, CLOSING_EXCLAMATION, GREATER_THAN_SIGN,
            LESS_THAN_SIGN, TILDE, DASH };
